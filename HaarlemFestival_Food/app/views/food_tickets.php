...
?>
<form class="form-inline" id="allergy" action="<?php echo URLROOT; ?>/Pages/orders" method="post">
...
<section class="form-group allergy-2">
    <input type="allergies" class="form-control" name="allergies" placeholder="allergies">
</section>
        ...
        <section class="col mb-2">
            <section class="row">
                ...
                <section class="col-sm-12 col-md-6 text-right">
                    <button href="<?php echo URLROOT; ?>/Pages/orders" class="btn btn-lg btn-block btn-success text-uppercase">Add to cart</button>
                </section>
            </section>
        </section>
    </section>
